/* Slip no : 3_2 Create a base class Student(Roll_No, Name)  which derives two classes Academic_Marks(Mark1, Mark2, Mark3)  and Extra_Activities_Marks(Marks).
Class Result(Total_Marks, Grade) inherits both Academic_Marks and Extra_Activities_Marks classes. (Use Virtual Base Class)
...
int main()
 {
  ...
  /* FOR RECORDING SINGLE STUDENT AND NOT N STUDENTS
  #include<conio.h>
#include<string.h>
#include<iostream>
using namespace std;
